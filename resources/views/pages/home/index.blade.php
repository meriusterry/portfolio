...
@section('content')
            ...
            <section class="about section" id="about">
               ...
               <div class="about_container container grid">
                 <img src="../../template/assets/img/pic3.png" alt="" class="about_img">
                 ...
                 <div class="about_data">
                    ...
                    <div class="about_buttons">
                        <a href="../../template/assets/pdf/Merius_Ntuli_CV.pdf" class="button button--flex" target="_blank">
              ...
              <div class="portfolio_container container swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="portfolio_content grid swiper-slide">
                        ...
                        <div class="portfolio_data">
                            <h3 class="portfolio_title">Recruitment System</h3>
                            <p class="portfolio_description">
                                A web-based platform that allows companies to post jobs, manage applications, 
                                and track candidates through the hiring process. Features include job listings, CV uploads, 
                                applicant tracking, role-based access, and interview scheduling.
                            </p>
                ...
                <div>
                    <div class="contact_information">
                        ...
                        <div>
                            ...
                            <span class="contact_subtitle">(+27)60 757 7774</span>
                        </div>
                    </div>
                    <div class="contact_information">
                        ...
                        <div>
                            ...
                            <span class="contact_subtitle">meriusterry@gmail.com</span>
                        </div>
                    </div>
                    <div class="contact_information">
                        ...
                        <div>
                            ...
                            <span class="contact_subtitle">Pretoria 0002</span>
                        </div>
                    </div>
                </div>
